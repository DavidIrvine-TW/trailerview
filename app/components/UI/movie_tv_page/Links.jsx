...
function Links({ imdb, website }) {
  return (
    <article className="px-4 flex gap-[1rem] my-[1.5rem] dk:px-0 dk:text-heading-xs">
      <Link href={`https://www.imdb.com/title/${imdb}`}>
        <button className="bg-secondary text-surface flex gap-[.5rem] items-center rounded px-4 py-2">
          <p>IMDB</p>
          <svg
            stroke="currentColor"
            fill="currentColor"
